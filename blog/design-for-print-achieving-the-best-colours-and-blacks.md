...
![Adobe swatches showing RGB and CMYK differences](/images/colours-blacks-1.webp)
...
![Acrobat Pro output preview showing CMYK](/images/colours-blacks-2.webp)<em>Above – the output preview in Acrobat showing anything CMYK. The page elements remain visible so they must be CMYK.</em>
...
![Acrobat Pro output preview showing CMYK colour breakdown](/images/colours-blacks-3.webp)<em>Above – hovering the cursor (not shown) over a colour in output preview will show the four CMYK values</em>
...
![Acrobat Pro output preview separations](/images/colours-blacks-4.webp)

1\. Above – Acrobat Pro output preview showing all four parts of CMYK, so every element on the page is visible.


![Acrobat Pro output preview separations](/images/colours-blacks-5.webp)
...
![Acrobat Pro output preview separations](/images/colours-blacks-6.webp)
...
![Adobe export settings](/images/colours-blacks-7.webp)
