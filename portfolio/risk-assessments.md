...
📝 **Brief:** Identify barriers to adoption make improvements to boost usage, satisfaction and sales.

👩 **Team** 

* Me – Senior Product Designer. I led the discovery and design. 
* Pete – Product Manager
* Maria – User Researcher
* Chris – Tech Lead.
...
* Increase user satisfaction – improving the Product Experience Score from its baseline of 48%, the lowest across all Eco products.
...
Pete and reviewed existing research and interviewed internal subject matter experts. One of them – Rob – described the Risk module as “the sleeping giant”.

John from Sales told us this:

<div class="feature-block" markdown="1">

> We’re embarrassed to sell the product – we know if we demo the Risk module for more than 3 minutes we’ll come across an extremely bad experience
...
I collaborated closely with subject matter experts to produce ideal-path user journeys. They helped root us in the context of use and the needs of our user types – an HSE manager, a member of an HSE team on site, and a frontline worker.
...
I reviewed products across EcoOnline to understand different approaches to Risk – for example, in chemical safety.
...
Our goal was to dig deep into customers’ experiences and unmet needs, to uncover problems and begin formulating opportunities. I hosted many of the calls.
...
* Our tech leads and Eco’s solutions architect once a week
...
One of our clients invited us to one of their sites – facilities management operations for a large office building and a hospital.
...
The site visit was a highlight of my professional year – it brought our work to life and helped us empathise with end users. I made a video for the team to help communicate our learnings.

### Sketching, flows and wireframes

I ran a sketching session with the team. Here’s a suggestion from Anita, a H&S expert. Aspects of the final solution can be traced back to her ideas. 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; – *Insight from a client*

</div>

With Maria’s help, I produced an affinity map – groups of insights, quotes and ideas from the interviews, to spot patterns.
...
One strand of insights related to Step 2 of the module. We’d learned that it was:
* Hard to read
* Inefficient to edit
* Inaccessible in some respects 

Linking back to our desk research, Anita’s ideas in the sketching session, the interviews with customers and learnings from the site visit, I designed a radically new experience.
...
This is an expandable, editable table that aligns with users’ mental models for risk assessments. It’s more visual and readable, with pictograms, colours, and no need to click in and out of sub-pages, making it a vastly more efficient experience both to edit and read.
...
I invited developers from our squad to join our tests – I’m delighted that there was a dev in every test. 
...
Here’s a clickthrough of the updated design, after testing.
...
Client feedback has been extremely positive. Here’s an audio clip:
...
> I love it. That is perfect. It's easy for me to say because I'm a health and safety professional, but this couldn't be any simpler for any person in our business to create an assessment and that's one of the key things – we need it to be simple. That, to me ticks all the boxes. They've got the different steps, they've got the pictograms, they've got the colour. I like everything about it, it is just what I wanted to see.

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; – *Feedback from a client*

</div>

I’m currently (Nov 2024) working with the engineers in our squad to deliver some quick wins which we’d identified during discovery, with a view to delivering the high impact priority areas in 2025.


### Reflections

In a group meeting during discovery, I shared early designs with stakeholders. One of them called me out for not being bold enough – he wanted to see a radically different approach with much greater usability gains. He was right. It was the kind of direct feedback I needed, and I quickly went back to the designs and made improvements. I thanked him for his input.

We’re lucky to have very engaged clients. In interviews, a couple of them were angry that EcoOnline hadn’t made more progress with the Risk module in the months and years before I joined the business. It was important I listened, understood and involved them. User interviews in B2B SaaS can sometimes involve these elements of diplomacy and communication, not only gathering insights.
